...
export default function JadwalPage() {
  ...
  const toggleActiveMutation = api.jadwal.toggleActive.useMutation({
    onSuccess: (data) => {
      toast.success(
        `Jadwal ${data?.isActive ? "diaktifkan" : "dinonaktifkan"}!`,
      );
      void refetchSchedules();
      void refetchStats();
    },
                          ...
                          <TableCell>
                            <div className="text-sm">
                              <div className="font-medium">
                                {schedule.mulaiMasuk.slice(0, 5)} -{" "}
                                {schedule.selesaiMasuk.slice(0, 5)}
                              </div>
                            </div>
                          </TableCell>
                          <TableCell>
                            <div className="text-sm">
                              <div className="font-medium">
                                {schedule.mulaiPulang.slice(0, 5)} -{" "}
                                {schedule.selesaiPulang.slice(0, 5)}
                              </div>
                            </div>
                          </TableCell>
                          <TableCell>
          ...
          <CardContent className="space-y-6">
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-4">
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      handleInputChange("mulaiMasuk", e.target.value)
                    }
                    required
                    className="w-full"
                  />
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      handleInputChange("selesaiMasuk", e.target.value)
                    }
                    required
                    className="w-full"
                  />
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      handleInputChange("mulaiPulang", e.target.value)
                    }
                    required
                    className="w-full"
                  />
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      handleInputChange("selesaiPulang", e.target.value)
                    }
                    required
                    className="w-full"
                  />
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      handleInputChange("kompensasiWaktu", e.target.value)
                    }
                    required
                    className="w-full"
                    placeholder="15"
              ...
              <Alert>
                ...
                <AlertDescription>
                  <strong>Kompensasi Waktu:</strong> Toleransi keterlambatan
                  dalam menit (0-120 menit). Waktu dalam format 24 jam (HH:MM).
                  Kompensasi waktu akan ditambahkan ke batas akhir waktu absen.
                </AlertDescription>
              </Alert>
            </form>
          </CardContent>
