...
export function AutoSearchForm({ type, initialValues, uniqueClasses = [] }: AutoSearchFormProps) {
    ...
    const [kelas, setKelas] = useState(
        type === "siswa" ? initialValues.kelas ?? "ALL" : initialValues.className ?? "ALL"
    );
    ...
    const hasActiveFilters = searchTerm || kelas !== "ALL" || kelamin !== "ALL" || activated !== "ALL";
        ...
        return (
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-5 gap-4">
                ...
                <div className="flex flex-col gap-2 w-full">
                    ...
                    <Select value={kelamin} onValueChange={setKelamin} disabled={isPending}>
                        <SelectTrigger className="w-full">
                ...
                <div className="flex flex-col gap-2 w-full">
                    ...
                    <Select value={activated} onValueChange={setActivated} disabled={isPending}>
                        <SelectTrigger className="w-full">
                            <SelectValue placeholder="Semua" />
                        </SelectTrigger>
                        <SelectContent>
