...
// Dummy chart config types and containers for demo
...
export function ChartLegendContent() {
  // Dummy legend content
  return <div style={{ fontSize: 12, color: '#888' }}>Legend</div>
}
...
export function ChartTooltipContent({ hideLabel }: { hideLabel?: boolean }) {
  // Dummy tooltip content
  return <div style={{ fontSize: 12, color: '#888' }}>{hideLabel ? null : 'Tooltip'}</div>
}
